      ...
      <div className='z-30 basis-2/5 mt-12 md:mt-32'>
        ...
        >
          <p className='text-6xl font-playfair z-10 text-center md:text-start'>
            ...
            before:absolute before:content-brush before:-left-[25px] before:-top-[70px] before:z-[-1]'>
             Esquivel
            </span>
           
          </p>
          <p className='mt-10 mb-7 text-sm text-center md:text-start'>
            I am a full stack web developer with experience in building and
            designing web applications. I specialize in React and React Native. 
